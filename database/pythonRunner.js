...
function runPythonFunction(functionName, functionArguments) {
  return new Promise((resolve, reject) => {
    ...
    const backendRoot = path.join(documentsRoot, 'HimCodePlaywrightBackend');
    ...
    const pythonFile = path.join(backendRoot, 'insert_patient_information.py');
    ...
    const python = spawn(pythonExecutable, [pythonFile, '--function', functionName], {
      windowsHide: true,
    });
